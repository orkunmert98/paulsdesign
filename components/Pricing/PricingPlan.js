                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div className="pricingTable text-left "style={{height:"100%"}}>
                                {/* <div className="pricing-icon">
                                    <i className="icofont-globe"></i>
                                </div> */}
                                <div className="price-Value pl-5 ml-5" style={{paddingTop:30,paddingBottom:10}}>
                            <span className="currency: 1, ml-5" style={{fontSize:50}}>{currency_data[this.state.currency_id].mark}</span> <span style={{color: "#fb6520"}}>{ this.state.switchAnnual ? ((this.state.sliderContacts -(this.state.sliderContacts*10/100))) *120* currency_data[this.state.currency_id].rate : this.state.sliderContacts * 10 * currency_data[this.state.currency_id].rate }</span>
                                </div>
                        ...
                        <div className="col-lg-4 col-md-12">
                            <div className="pricingTable" style={{height:"100%"}}>
                                {/* <div className="pricing-icon">
                                    <i className="icofont-globe"></i>
                                </div> */}
                                {/* <div className="price-Value">
